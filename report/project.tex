...
\begin{homeworkProblem}{Part 1: classical Bandit Algorithms}
    ...
    \begin{enumerate}
        ...
        \begin{enumerate}
            ...
            Considering this common goal, we decided that generating random data on this problem has less meaning to real-life applications of this problem, 
            and it is rather difficult to make the generated data reasonable and representitive.
            So we considered the real-life application of the dependent multi-arm bandit problem, more specifically, the problem of movie promotion.
        ...
        %     $count(C(j)) \leftarrow$ sum of all $\alpha,\beta$ in the cluster.\\030731
